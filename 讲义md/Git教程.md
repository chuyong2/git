...
- 创建文件： touch 文件名
- 查看状态：git status
- 添加工作区到暂存区： git add 文件名（所以即用通配符 .）
- 提交暂存区到本地仓库： git commit -m "注释"
- 查看日志: git log [option]
  - --all:显示所有分支
...
- 版本回退：git reset --hard commitID
  - commitID可以通过     ` git log --pretty=oneline --all --graph --abbrev-commit                                                                                                                                                          `    或git log指令查看
  - 查看已删除记录git reflog

![image-20230108161239605](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230108161239605.png)

![image-20230108161258295](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230108161258295.png)

- 版本回退

![image-20230108164653943](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230108164653943.png)
...
- git checkout 分支名
- git checkout -b 不存在的分支名(创建并切换到新创建的分支)

```
右键--> 检出
```

![image-20230109220604862](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230109220604862.png)

![image-20230109220710877](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230109220710877.png)
...
![image-20230109222437598](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230109222437598.png)

![image-20230109222551626](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230109222551626.png)
...
首先模拟一下，创建新的分支为dev，修改file01，将count改为2最后提交

![image-20230109224105511](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230109224105511.png)

再修改为master分支，修改count为3，合并dev到master发现冲突合并失败

![image-20230109224151600](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230109224151600.png)

解决冲突即在发生冲突的文件中修改最终的结果提交即可

![image-20230109224217942](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230109224217942.png)
...
![image-20230110215927137](C:\Users\86189\AppData\Roaming\Typora\typora-user-images\image-20230110215927137.png)
